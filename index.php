...
$result = $dbConn->query("SELECT * FROM personne ORDER BY idPersonne DESC");
?>
...
<html lang="en">
 ...
 <div class="col-4 offset-3">
	 <div class="card text-center">
	   <div class="card-body">
		 <h4 class="card-titl " style="color: #163c57;">Liste des Contacts<h4>
	   </div>
	 </div>
 ...
 <div style="height: 10vh;"></div>
   ...
   <!--Tableau-->
	...
	while($row = $result->fetch(PDO::FETCH_ASSOC)) { 		
		...
		echo "<td><a href=\"edit.php?idPersonne=$row[idPersonne]\">Edit</a> | <a href=\"delete.php?idPersonne=$row[idPersonne]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";		
	}
	?>
	</table>
